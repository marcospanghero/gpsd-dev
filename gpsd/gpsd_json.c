                   ...
                   char *reply, size_t replylen)
{
    ...
    str_appendf(reply, replylen, ",\"clock\":[{\"clock_bias\":%.6f,\"clock_drift\":%.6f,\"tacc_est\":%.6f,\"facc_est\":%.6f}]", gpsdata->fix.clockspec.clock_bias, gpsdata->fix.clockspec.clock_drift, gpsdata->fix.clockspec.tAcc_estimate, gpsdata->fix.clockspec.fAcc_estimate);
