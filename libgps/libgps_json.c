                         ...
                         const char **endptr)
{
    ...
    const struct json_attr_t json_attrs_1[] = {
        ...
        {"wspeedt", t_real, .addr.real = &gpsdata->fix.wspeedt,
                                 .dflt.real = NAN},
        {"clock_bias", t_integer, .addr.integer = &gpsdata->fix.clockspec.clock_bias,
                                 .dflt.integer = NAN},
        {"clock_drift", t_integer, .addr.integer = &gpsdata->fix.clockspec.clock_drift,
                                 .dflt.integer = NAN},
        {"tacc_est", t_integer, .addr.integer = &gpsdata->fix.clockspec.tAcc_estimate,
                                 .dflt.integer = NAN},   
        {"facc_est", t_integer, .addr.integer = &gpsdata->fix.clockspec.fAcc_estimate,
                                 .dflt.integer = NAN},                           
