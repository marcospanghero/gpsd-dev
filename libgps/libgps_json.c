                         ...
                         const char **endptr)
{
    ...
    const struct json_attr_t json_attrs_1[] = {
        ...
        {"wspeedt", t_real, .addr.real = &gpsdata->fix.wspeedt,
                                 .dflt.real = NAN},
        {"clock_bias", t_integer, .addr.real = &gpsdata->fix.clockspec.clock_bias,
                                 .dflt.real = NAN},
        {"clock_drift", t_integer, .addr.real = &gpsdata->fix.clockspec.clock_drift,
                                 .dflt.real = NAN},
        {"tacc_est", t_integer, .addr.real = &gpsdata->fix.clockspec.tAcc_estimate,
                                 .dflt.real = NAN},   
        {"facc_est", t_integer, .addr.real = &gpsdata->fix.clockspec.fAcc_estimate,
                                 .dflt.real = NAN},                           
